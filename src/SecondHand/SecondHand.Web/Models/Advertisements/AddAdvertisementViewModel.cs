...
{
    public class AddAdvertisementViewModel : IMapFrom<Advertisement>, IHaveCustomMappings
    {
        [Required]
        [Display(Name = "Title")]
        ...
        {
            configuration.CreateMap<Advertisement, AddAdvertisementViewModel>()
            ...
            configuration.CreateMap<AddAdvertisementViewModel, Advertisement>()
